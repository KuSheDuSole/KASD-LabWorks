...
namespace MyLinkedList
{
    ...
    public class MyLinkedList<T>: IEnumerable
    {
        ...
        {
            foreach (T obj in this) if (obj.Equals(element)) return true;
            return false;
        }
        ...
        public T[] ToArray()
        {
            T[] values = new T[size];
            int index = 0;
            foreach (T element in this) values[index++] = element;
            return values;
        }
        ...
        //public void Print()
        //{
        //    foreach (T element in this) Console.WriteLine(element);
        //    Console.WriteLine();
        //}
